...
{
    public class BigLionDatabaseContext : DbContext, IBigLionDatabaseContext
    {
        ...
        public BigLionDatabaseContext(
            DbContextOptions<BigLionDatabaseContext> options,
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(BigLionDatabaseContext).Assembly);
