...
using BigLion.Application.Features.Checkups.Constants;
using BigLion.Domain.Entities;

namespace BigLion.Application.Features.Xrays.Commands.Create;
...
public class CreateXrayCommandValidator : AbstractValidator<CreateXrayCommand>
{
    ...
    public CreateXrayCommandValidator(ICheckupDatabaseContext context)
    {
        _context = context;
...
public class CreateXrayCommandHandler : IRequestHandler<CreateXrayCommand, int>
{
    ...
    public CreateXrayCommandHandler(ICheckupDatabaseContext context)
    {
        _context = context;
    }
