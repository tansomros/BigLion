...
namespace BigLion.Application.Features.Companies.Commands.Create
{
    ...
    {
        private readonly IBigLionDatabaseContext _BigLionDatabaseContext;

        public CreateCompanyCommmandHandler(IBigLionDatabaseContext BigLionDatabaseContext)
        {
            _BigLionDatabaseContext = BigLionDatabaseContext;
        }
        ...
        public async Task<int> Handle(CreateCompanyCommand request, CancellationToken cancellationToken)
        {
            ...
            await _BigLionDatabaseContext.Company.AddAsync(company, cancellationToken);
            await _BigLionDatabaseContext.SaveChangesAsync(cancellationToken);
            return company.Id;
        }
    }
}
