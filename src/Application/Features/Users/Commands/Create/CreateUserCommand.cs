...
namespace BigLion.Application.Features.Users.Commands.Create;
...
{ 
    ...
    public CreateUserCommandValidator(IBigLionDatabaseContext context)
    {
        _context = context;     
...
{
    private readonly IBigLionDatabaseContext _context;
    public CreateUserCommandHandler(IBigLionDatabaseContext context)
    {
        _context = context;
    }
