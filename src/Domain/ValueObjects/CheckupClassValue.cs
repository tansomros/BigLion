...
{
   public class CheckupClassValue
    {
        ...
        public static readonly string UrineAnalysis = "UA";
        public static readonly string StoolExamination = "ST";
        ...
        public static readonly string OtherTest = "O";
        public static readonly string ObstetricExam = "W";
        public static readonly string Confidential = "CD";
